...
void PortsConfig(void)
{
    ...
    RD0PPS = 0x12;
    RD1PPS = 0x11;
    SSP2DATPPS = 0b00011000;
    SSP2CLKPPS = 0b00011001;
...
void RequestData (void)
{
    ...
    for(i = 0x10; i <= lastSensor; i+=2)
    {
        ...
        for(i2 = 1; i2 <= distanceBytes; i2++)
        {
            byteCount++;
            I2C1Registers[byteCount] = distData[i2 - 1];
        }
    }
